...
public class CombinadorProductos {
    ...
    private static void generarCombinaciones(List<Producto> productos, int index, List<Producto> combinacionActual, double presupuestoRestante, List<List<Producto>> resultado) {
    ...
    public static void main(String[] args) {
        ...
        // Convertir el Set en una List
        List<Producto> productos = new ArrayList<>(productosCargados);

        // Calcular combinaciones con un presupuesto
